...
# cv.run_pipline()
# cv.summary_matrix_cross_hirachia('ACC')
cv.summary_matrix_non_overlapping_site('ACC', target_calculate="mean")

# cv.summary_matrix_cross("ACC")
# cv.summary_matrix_cross("TPR")
# cv.summary_matrix_cross("FNR")
# cv.summary_matrix_cross("FPR")
# cv.summary_matrix_cross("TNR")
...
# c = "/sise/home/efrco/efrco-master/Results/figuers/xgbs/shap/"
# importabce = "/sise/home/efrco/efrco-master/Results/figuers/xgbs/feature_importance/"
# paths = [c,importabce,measurment_cross]
...
#                           number_iteration=0, name_classifier='xgbs')#8576604

# D = read_csv("/sise/home/efrco/efrco-master/data/negative_interactions/non_overlapping_sites/non_overlapping_sites_top_darnell_human_ViennaDuplex_negative_features.csv")
# print("f")
# print("")
...
# res_table = pd.DataFrame()
#
# res_table.loc['Mock_miRNA', "Mock_miRNA"] = float(0)
# res_table.loc['Mock_miRNA', "Mock_di_fragment_&_miRNA"] = float(0.62)
# res_table.loc['Mock_miRNA', "Mock_di_mRNA"] = float(0.56)
# res_table.loc['Mock_miRNA', "Mock_di_fragment"] = float(0.61)
# res_table.loc['Mock_miRNA', "NPS_CLASH_MFE"] = float(0.54)
# res_table.loc['Mock_miRNA', "NPS_CLASH_Random"] = float(0.65)
# res_table.loc['Mock_miRNA', "TarBase_microarray"] = float(0.56)
# res_table.loc['Mock_miRNA', "CLIP_non_CLASH"] = float(0.64)
# res_table.loc['Mock_miRNA', "NPS_CLIP_Random"] = float(0.65)
#
# res_table.loc['Mock_di_fragment_&_miRNA', "Mock_miRNA"] = float(0.62)
# res_table.loc['Mock_di_fragment_&_miRNA', "Mock_di_fragment_&_miRNA"] = float(0)
# res_table.loc['Mock_di_fragment_&_miRNA', "Mock_di_mRNA"] = float(0.64)
# res_table.loc['Mock_di_fragment_&_miRNA', "Mock_di_fragment"] = float(0.55)
# res_table.loc['Mock_di_fragment_&_miRNA', "NPS_CLASH_MFE"] = float(0.62)
# res_table.loc['Mock_di_fragment_&_miRNA', "NPS_CLASH_Random"] = float(0.56)
# res_table.loc['Mock_di_fragment_&_miRNA', "TarBase_microarray"] = float(0.64)
# res_table.loc['Mock_di_fragment_&_miRNA', "CLIP_non_CLASH"] = float(0.56)
# res_table.loc['Mock_di_fragment_&_miRNA', "NPS_CLIP_Random"] = float(0.57)
#
# res_table.loc['Mock_di_mRNA', "Mock_miRNA"] = float(0.57)
# res_table.loc['Mock_di_mRNA', "Mock_di_fragment_&_miRNA"] = float(0.64)
# res_table.loc['Mock_di_mRNA', "Mock_di_mRNA"] = float(0)
# res_table.loc['Mock_di_mRNA', "Mock_di_fragment"] = float(0.61)
# res_table.loc['Mock_di_mRNA', "NPS_CLASH_MFE"] = float(0.55)
# res_table.loc['Mock_di_mRNA', "NPS_CLASH_Random"] = float(0.65)
# res_table.loc['Mock_di_mRNA', "TarBase_microarray"] = float(0.56)
# res_table.loc['Mock_di_mRNA', "CLIP_non_CLASH"] = float(0.66)
# res_table.loc['Mock_di_mRNA', "NPS_CLIP_Random"] = float(0.68)
#
# res_table.loc['Mock_di_fragment', "Mock_miRNA"] = float(0.6)
# res_table.loc['Mock_di_fragment', "Mock_di_fragment_&_miRNA"] = float(0.55)
# res_table.loc['Mock_di_fragment', "Mock_di_mRNA"] = float(0.62)
# res_table.loc['Mock_di_fragment', "Mock_di_fragment"] = float(0)
# res_table.loc['Mock_di_fragment', "NPS_CLASH_MFE"] = float(0.6)
# res_table.loc['Mock_di_fragment', "NPS_CLASH_Random"] = float(0.57)
# res_table.loc['Mock_di_fragment', "TarBase_microarray"] = float(0.61)
# res_table.loc['Mock_di_fragment', "CLIP_non_CLASH"] = float(0.58)
# res_table.loc['Mock_di_fragment', "NPS_CLIP_Random"] = float(0.6)
#
# res_table.loc['NPS_CLASH_MFE', "Mock_miRNA"] = float(0.56)
# res_table.loc['NPS_CLASH_MFE', "Mock_di_fragment_&_miRNA"] = float(0.63)
# res_table.loc['NPS_CLASH_MFE', "Mock_di_mRNA"] = float(0.54)
# res_table.loc['NPS_CLASH_MFE', "Mock_di_fragment"] = float(0.61)
# res_table.loc['NPS_CLASH_MFE', "NPS_CLASH_MFE"] = float(0)
# res_table.loc['NPS_CLASH_MFE', "NPS_CLASH_Random"] = float(0.65)
# res_table.loc['NPS_CLASH_MFE', "TarBase_microarray"] = float(0.56)
# res_table.loc['NPS_CLASH_MFE', "CLIP_non_CLASH"] = float(0.64)
# res_table.loc['NPS_CLASH_MFE', "NPS_CLIP_Random"] = float(0.65)
#
# res_table.loc['NPS_CLASH_Random', "Mock_miRNA"] = float(0.64)
# res_table.loc['NPS_CLASH_Random', "Mock_di_fragment_&_miRNA"] = float(0.55)
# res_table.loc['NPS_CLASH_Random', "Mock_di_mRNA"] = float(0.66)
# res_table.loc['NPS_CLASH_Random', "Mock_di_fragment"] = float(0.56)
# res_table.loc['NPS_CLASH_Random', "NPS_CLASH_MFE"] = float(0.64)
# res_table.loc['NPS_CLASH_Random', "NPS_CLASH_Random"] = float(0)
# res_table.loc['NPS_CLASH_Random', "TarBase_microarray"] = float(0.65)
# res_table.loc['NPS_CLASH_Random', "CLIP_non_CLASH"] = float(0.56)
# res_table.loc['NPS_CLASH_Random', "NPS_CLIP_Random"] = float(0.57)
#
# res_table.loc['TarBase_microarray', "Mock_miRNA"] = float(0.57)
# res_table.loc['TarBase_microarray', "Mock_di_fragment_&_miRNA"] = float(0.64)
# res_table.loc['TarBase_microarray', "Mock_di_mRNA"] = float(0.57)
# res_table.loc['TarBase_microarray', "Mock_di_fragment"] = float(0.62)
# res_table.loc['TarBase_microarray', "NPS_CLASH_MFE"] = float(0.56)
# res_table.loc['TarBase_microarray', "NPS_CLASH_Random"] = float(0.66)
# res_table.loc['TarBase_microarray', "TarBase_microarray"] = float(0)
# res_table.loc['TarBase_microarray', "CLIP_non_CLASH"] = float(0.66)
# res_table.loc['TarBase_microarray', "NPS_CLIP_Random"] = float(0.66)
#
# res_table.loc['CLIP_non_CLASH', "Mock_miRNA"] = float(0.65)
# res_table.loc['CLIP_non_CLASH', "Mock_di_fragment_&_miRNA"] = float(0.54)
# res_table.loc['CLIP_non_CLASH', "Mock_di_mRNA"] = float(0.66)
# res_table.loc['CLIP_non_CLASH', "Mock_di_fragment"] = float(0.57)
# res_table.loc['CLIP_non_CLASH', "NPS_CLASH_MFE"] = float(0.64)
# res_table.loc['CLIP_non_CLASH', "NPS_CLASH_Random"] = float(0.57)
# res_table.loc['CLIP_non_CLASH', "TarBase_microarray"] = float(0.65)
# res_table.loc['CLIP_non_CLASH', "CLIP_non_CLASH"] = float(0)
# res_table.loc['CLIP_non_CLASH', "NPS_CLIP_Random"] = float(0.54)
#
# res_table.loc['NPS_CLIP_Random', "Mock_miRNA"] = float(0.65)
# res_table.loc['NPS_CLIP_Random', "Mock_di_fragment_&_miRNA"] = float(0.57)
# res_table.loc['NPS_CLIP_Random', "Mock_di_mRNA"] = float(0.66)
# res_table.loc['NPS_CLIP_Random', "Mock_di_fragment"] = float(0.59)
# res_table.loc['NPS_CLIP_Random', "NPS_CLASH_MFE"] = float(0.645)
# res_table.loc['NPS_CLIP_Random', "NPS_CLASH_Random"] = float(0.55)
# res_table.loc['NPS_CLIP_Random', "TarBase_microarray"] = float(0.66)
# res_table.loc['NPS_CLIP_Random', "CLIP_non_CLASH"] = float(0.55)
# res_table.loc['NPS_CLIP_Random', "NPS_CLIP_Random"] = float(0)
#
# transposed_df = res_table.transpose(copy=False)
#
# cmap = sns.cm.rocket_r
# ax = sns.heatmap(transposed_df, annot=True, linewidth=(2.5, 0), cmap=cmap, vmin=0.50, vmax=0.68, cbar_kws={'format': '%.2f'})
# ax.set(xlabel="Dataset B", ylabel="Dataset A")
# plt.xticks(rotation=30, ha='right')
...
# #second figure
#
# fname = "/sise/home/efrco/acc_cross_lior_acc.png"
# plt.savefig(fname, format="PNG", bbox_inches='tight', dpi=300)
# plt.show()
# plt.clf()